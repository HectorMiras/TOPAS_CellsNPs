...
TsScorerPhaseSpaceNP::TsScorerPhaseSpaceNP(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM, TsScoringManager* scM, TsExtensionManager* eM,
...
TsScorerPhaseSpaceNP::~TsScorerPhaseSpaceNP()
{;}
...
void TsScorerPhaseSpaceNP::AccumulateEvent()
{
...
void TsScorerPhaseSpaceNP::AbsorbResultsFromWorkerScorer(TsVScorer* workerScorer)
{
    TsVNtupleScorer::AbsorbResultsFromWorkerScorer(workerScorer);

    // Absorb additional statistics
    TsScorerPhaseSpaceNP* workerPhaseSpaceScorer = dynamic_cast<TsScorerPhaseSpaceNP*>(workerScorer);
...
void TsScorerPhaseSpaceNP::UpdateForEndOfRun() {
...
void TsScorerPhaseSpaceNP::Output()
{
...
void TsScorerPhaseSpaceNP::Clear()
{
    fScoredHistories = 0;
